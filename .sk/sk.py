...
TOOLCHAIN = {
    "cc": "clang",
    "cflags": "-std=gnu23 -Isrc -Wall -Wextra -Werror -fcolor-diagnostics",
    "cxx": "clang++",
    "cxxflags": "-std=gnu++2b -Isrc -Wall -Wextra -Werror -fcolor-diagnostics",
    "ld": "clang++",
    "ldflags": "",
    "ar": "llvm-ar",
    "arflags": "",
...
def generate_ninja(out: TextIO, manifest: dict, env: dict, toolchain: dict) -> None:
    ...
    writer.comment("Toolchain:")
    for key in toolchain:
        writer.variable(key, toolchain[key])
    writer.newline()
...
manifests = list2dict(filter_manifests(manifests_list, ENV))
