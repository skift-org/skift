...
void draw_path(Graphic::Painter &painter, const Graphic::Path &path, Mat3x2f transform, Graphic::Color color)
{
...
void path_draw(Graphic::Painter &painter, Recti, float)
{
    ...
    rast.fill(p0, Mat3x2f::scale(10) * Mat3x2f::translation({72, 48}), Graphic::Fill{Graphic::Colors::MAGENTA.with_alpha(0.5)});
    rast.fill(p1, Mat3x2f::scale(10) * Mat3x2f::translation({72, 48}), Graphic::Fill{Graphic::Colors::CYAN.with_alpha(0.5)});

    draw_path(painter, p0, Mat3x2f::scale(10) * Mat3x2f::translation({-5, 48}), Graphic::Colors::BLUE);
    draw_path(painter, p1, Mat3x2f::scale(10) * Mat3x2f::translation({-5, 48}), Graphic::Colors::GREEN);
}