...
#define COLOR(__r, __g, __b) ((color_t){{__r, __g, __b, 255}})
...
#define COLOR_ENUM_ENTRY(__name_maj, __name_lower, __r, __g, __b) static color_t COLOR_##__name_maj = (color_t){{__r, __g, __b, 255}};
