...
DEFN_SYSCALL2(sk_thread_cancel, SYS_THREAD_CANCEL, int, void*);

DEFN_SYSCALL1(sk_thread_sleep, SYS_THREAD_SLEEP, int);
DEFN_SYSCALL1(sk_thread_wakeup, SYS_THREAD_WAKEUP, int);

DEFN_SYSCALL2(sk_thread_wait_thread, SYS_THREAD_WAIT_THREAD, int, int *);
DEFN_SYSCALL2(sk_thread_wait_process, SYS_THREAD_WAIT_PROCESS, int, int *);