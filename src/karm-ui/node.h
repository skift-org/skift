...
struct FlowLayout : public Group<FlowLayout> {
    ...
    FlowLayout(Children children) : Group(children), _flow(Flow::LEFT_TO_RIGHT) {}

    FlowLayout(Flow flow, Children children) : Group(children), _flow(flow) {}
...
Child flow(Flow flow, Children children) {
...
Child flow(Flow flow, auto... children) {
