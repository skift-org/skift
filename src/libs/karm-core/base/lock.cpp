export module Karm.Core:base.lock;
...
export struct [[nodiscard]] CriticalScope : Meta::Pinned {
    CriticalScope() {
...
export struct Lock : Meta::Pinned {
    Atomic<bool> _lock{};
...
export struct NoLock : Meta::Pinned {
    bool tryAcquire() {
        return true;
    }
...
struct [[nodiscard]] LockScope : Meta::Pinned {
    L& _lock;
...
export struct [[nodiscard]] ReadLockScope : Meta::Pinned {
    RwLock& _lock;
...
export struct [[nodiscard]] WriteLockScope : Meta::Pinned {
    RwLock& _lock;
