...
template <>
struct Karm::Io::Formatter<Vaev::Http::Code> {
    Res<usize> format(Io::TextWriter &writer, Vaev::Http::Code code) {
        return writer.writeStr(Vaev::Http::toStr(code));
    }
};

template <>
struct Karm::Io::Formatter<Vaev::Http::Method> {
    Res<usize> format(Io::TextWriter &writer, Vaev::Http::Method method) {
        return writer.writeStr(Vaev::Http::toStr(method));
    }
};

template <>
struct Karm::Io::Formatter<Vaev::Http::Version> {
    Res<usize> format(Io::TextWriter &writer, Vaev::Http::Version version) {
