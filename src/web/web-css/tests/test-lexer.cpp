...
test$(comments) {
    ...
    expect$(t.type == Token::Type::COMMENT);
...
test$(numbers) {
    auto s = Io::SScan("123");
    auto t = try$(nextToken(s));
    expect$(t.type == Token::Type::NUMBER);
    expectEq$(t.data, "123");

    s = Io::SScan("123%");
    t = try$(nextToken(s));
    expect$(t.type == Token::Type::PERCENTAGE);
    expectEq$(t.data, "123%");
    ...
    s = Io::SScan("123px");
    t = try$(nextToken(s));
    expect$(t.type == Token::Type::DIMENSION);
...
test$(strings) {
    auto s = Io::SScan("''");
    auto t = try$(nextToken(s));
    expect$(t.type == Token::Type::STRING);
