...
void Tokenizer::consume(Rune rune, bool isEof) {
    ...
    case State::NUMERIC_CHARACTER_REFERENCE_END: {
        ...
        Array CONV = {
            Cons<u8, usize>{0x80, 0x20AC},
            Cons<u8, usize>{0x82, 0x201A},
            Cons<u8, usize>{0x83, 0x0192},
            Cons<u8, usize>{0x84, 0x201E},
            Cons<u8, usize>{0x85, 0x2026},
            Cons<u8, usize>{0x86, 0x2020},
            Cons<u8, usize>{0x87, 0x2021},
            Cons<u8, usize>{0x88, 0x02C6},
            Cons<u8, usize>{0x89, 0x2030},
            Cons<u8, usize>{0x8A, 0x0160},
            Cons<u8, usize>{0x8B, 0x2039},
            Cons<u8, usize>{0x8C, 0x0152},
            Cons<u8, usize>{0x8E, 0x017D},
            Cons<u8, usize>{0x91, 0x2018},
            Cons<u8, usize>{0x92, 0x2019},
            Cons<u8, usize>{0x93, 0x201C},
            Cons<u8, usize>{0x94, 0x201D},
            Cons<u8, usize>{0x95, 0x2022},
            Cons<u8, usize>{0x96, 0x2013},
            Cons<u8, usize>{0x97, 0x2014},
            Cons<u8, usize>{0x98, 0x02DC},
            Cons<u8, usize>{0x99, 0x2122},
            Cons<u8, usize>{0x9A, 0x0161},
            Cons<u8, usize>{0x9B, 0x203A},
            Cons<u8, usize>{0x9C, 0x0153},
            Cons<u8, usize>{0x9E, 0x017E},
            Cons<u8, usize>{0x9F, 0x0178},
        };
