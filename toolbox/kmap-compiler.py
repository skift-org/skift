...
outfp.write(struct.pack("I", len(data["bindings"])))
...
for key in data["bindings"]:
    ...
    if len(bind) == 4:
        print(bind)
        outfp.write(struct.pack("IIIII", KEYS[key], 0 if len(bind[0]) == 0 else ord(bind[0]), 0 if len(bind[1]) == 0 else ord(bind[1]), 0 if len(bind[2]) == 0 else ord(bind[2]), 0 if len(bind[3]) == 0 else ord(bind[3])))
        print(KEYS[key], 0 if len(bind[0]) == 0 else ord(bind[0]), 0 if len(bind[1]) == 0 else ord(bind[1]), 0 if len(bind[2]) == 0 else ord(bind[2]), 0 if len(bind[3]) == 0 else ord(bind[3]))
