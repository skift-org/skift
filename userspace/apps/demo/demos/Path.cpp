...
void path(Graphic::Painter &painter, Math::Recti, float)
{
    ...
    painter.fill(p0, Math::Mat3x2f::scale(10), Graphic::Fill{Graphic::Colors::MAGENTA.with_alpha(0.5)});
    painter.fill(p1, Math::Mat3x2f::scale(10), Graphic::Fill{Graphic::Colors::CYAN.with_alpha(0.5)});
